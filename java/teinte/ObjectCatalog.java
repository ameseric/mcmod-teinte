...
import teinte.block.AshReplicatingBlock;
import teinte.block.BlockAsh;
import teinte.block.BlockCatarCortex;
import teinte.block.BlockCatarMaw;
import teinte.block.BlockFlesh;
import teinte.block.BlockGuidestone;
import teinte.block.ConduitBlock;
import teinte.block.DebugBlock;
import teinte.block.KaliCoreBlock;
import teinte.block.MuirGeyserBlock;
import teinte.block.RitualBlock;
import teinte.entity.DroneEntity;
import teinte.entity.GhastTestEntity;
import teinte.entity.WitherSkeletonTestEntity;
import teinte.items.TestFireball;
import teinte.potions.TestPotion;
import teinte.potions.TestPotionType;
import teinte.tileentity.TileEntityCataromotus;
import teinte.tileentity.TileEntityMaw;
import teinte.tileentity.TileEntitySerpentmind;


// stateless singleton
// necessary due to MCForge's structure, not desired choice
